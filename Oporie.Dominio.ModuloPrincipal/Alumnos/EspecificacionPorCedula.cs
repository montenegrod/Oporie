...
{
    /// <summary>
    /// Especificación de AdHoc para encontrar Alumnos por criterio Cédula 
    /// </summary>
    public class EspecificacionPorCedula : Specification<ALUMNO>
    {
        ...
        #region Constructor
        public EspecificacionPorCedula(string alumnoCriterio)
        {
        ...
        public override System.Linq.Expressions.Expression<Func<ALUMNO, bool>> SatisfiedBy()
        {
            ...
            //Especificación igual a campo ALU_CEDULA
            spec &= new DirectSpecification<ALUMNO>(c => c.ALU_CEDULA != null && (c.ALU_CEDULA.ToUpper() == _StrCriterioAlumno.ToUpper()));
